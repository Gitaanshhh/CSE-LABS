// Write a C program to rotate the stepper motor in the opposite direction when SW2 is pressed
...
unsigned int switchState=1, flag = 1;
...
int main(void) { 
	...
	while(1){ 
		...
		for(k=0;k<2600;k++);        // Delay to show clock Rotation  
